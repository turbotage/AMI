...
% Rebeccas adaption of mymedfilt for H-scan. 
% Can handle rgb indata with or without a temporal dimension, returns one
% median filtered rgb channel. Neigh is the kernel chosen for the
% computations (it has a default value.)
